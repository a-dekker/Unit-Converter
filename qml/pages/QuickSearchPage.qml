    ...
    SilicaListView {
        ...
        header: SearchField {
                    ...
                    onTextChanged: {
                        ...
                        searchString = text
                        if (["angle","area","curr","data","dens","ener","flow","force",
                             "freq","fuel","leng","magnetic fi","magnetic fl",
                             "mass","numb","power","pres","speed",
                             "temp","time","torq","vol"].indexOf(searchString.toLowerCase()) !== -1) {
    ...
    onStatusChanged: {
        if (status === PageStatus.Activating) {
            if (!proxymodel.isModelPopulated()) {
                proxymodel.insertUnits("angle",{"degrees": "deg","gradian": "grad","radians":"rad"});
                proxymodel.insertUnits("area",{"acres": "acre","hectares": "ha",
                ...
                proxymodel.insertUnits("energy and work",{"British thermal units": "Btu","calories": "cal",
                                       "electron volts": "eV", "ergs": "erg", "foot-pounds": "ftlb",
                                       "joules": "J", "kilocalories": "kcal","kilojoules": "kJ",
                                       "kilowatt-hours": "kWh","newton-meters": "Nm"});
                proxymodel.insertUnits("flow",{"cubic foot per minute": "cfm", "cubic meter per hour": "m3/h",
                                           "cubic meter per second": "m3/s", "litres per minute": "L/min"});
                proxymodel.insertUnits("force",{"dynes": "dyn","kilopounds": "kip",
                                       "kilonewtons": "kN", "pounds": "lbf", "newtons": "N",
                                       "ounces-force": "ozf"});
                proxymodel.insertUnits("frequency",{"gigahertz": "GHz","hertz": "Hz",
                ...
                proxymodel.insertUnits("length",{"angstroms": "A","astronomical units": "au",
                                       ...
                                       "meters": "m","micrometers or microns": "um","miles":"mi",
                                       "millimeters":"mm","mil or thou":"mil","nautical miles": "nautmi",
                                       "nanometers": "nm","picometers":"pm","yards":"yd"});
                proxymodel.insertUnits("magnetic field strength",{"ampere per meter": "A/m", "oersted": "Oe"});
                proxymodel.insertUnits("magnetic flux density",{"gamma": "gamma", "gauss": "Gs", "tesla": "T"});
                proxymodel.insertUnits("mass",{"atomic mass units": "amu","grams": "g","grains": "gr",
                                       "kilograms": "kg", "pounds-mass": "lbm", "microgram": "ug",
                                       "milligrams": "mg","ounce":"oz","slugs": "slug"});
                ...
                proxymodel.insertUnits("pressure",{"standard atmospheres": "atm","bar": "bar",
                                       "dynes per square centimeter": "dyn/cm2", "feet of water column at 4°C": "ftAgua",
                                       "hectopascals": "hPa","inches of water column at 4°C":"inAgua","megapascals":"MPA",
                                       "kilopascals":"kPa","millibar":"mbar","millimeters of mercury at 0°C": "mmHg",
                                       "pascals(newton per meter)": "Pa","pounds per square inch":"psi","torr":"Torr"});
                proxymodel.insertUnits("speed",{"feet per second": "ft/s","kilometers per hour": "km/h",
                                       "knots": "knot", "mach number at STP": "mach",
                                       "miles per hour": "mph","meters per second":"m/s"});
                proxymodel.insertUnits("temperature",{"celsius": "C","fahrenheit": "F",
                                       "kelvin": "K", "rankine": "R"});
                proxymodel.insertUnits("time",{"days": "day","hours": "hr","microseconds": "us",
                                       "minutes": "min", "milliseconds": "ms","nanoseconds":"ns",
                                       "seconds": "s", "years": "yr","weeks": "wk"});
                proxymodel.insertUnits("torque",{"dyne centimeter": "dyn-cm","dyne meter": "dyn-m","gram-force meter": "gf-m",
                                       "kilogram-force meter": "kgf-m", "newton centimeter": "N-cm","newton meter":"N-m",
                                       "ounce-force inch": "ozf-in", "pound-force foot": "lbf-ft",
